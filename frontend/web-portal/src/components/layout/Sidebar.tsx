...
import {
  ...
  List, CreditCard, TrendingUp, Home, LogOut, HeartPulse,
} from 'lucide-react';
...
const ICON_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
  LayoutDashboard, Users, CalendarDays, Stethoscope, Receipt,
  Banknote, BarChart3, FileText, Clipboard, Settings, Zap,
  List, CreditCard, TrendingUp, Home,
};
...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen flex-shrink-0" style={{ background: 'var(--gradient-sidebar)' }}>
      {/* Logo */}
