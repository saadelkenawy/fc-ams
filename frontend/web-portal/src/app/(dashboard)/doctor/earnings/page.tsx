                  ...
                  <CTable className="w-full text-sm">
                    <CTableHead>
                      <CTableRow className="border-b border-gray-50 dark:border-neutral-700 bg-gray-50/50 dark:bg-neutral-900/40">
                        ...
                        <CTableHeaderCell className="text-start px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">{t('المصدر', 'Source')}</CTableHeaderCell>
                        ...
                        <CTableHeaderCell className="text-end px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">{t('حصتي', 'My Share')}</CTableHeaderCell>
                        <CTableHeaderCell className="text-end px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">{t('رسوم المصدر', 'Source Fee')}</CTableHeaderCell>
                    ...
                    <CTableBody>
                      {transactions.map((tx) => (
                        ...
                        >
                          ...
                          <CTableDataCell className="px-5 py-3.5 text-end font-mono tabular-nums text-amber-600 dark:text-amber-400">
