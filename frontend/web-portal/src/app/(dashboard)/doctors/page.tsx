...
const MOCK_DOCTORS = [
  { id: 'd1', nameAr: 'د. هدى إبراهيم',  nameEn: 'Dr. Hoda Ibrahim',   specialtyAr: 'النساء والعقم',     specialtyEn: 'Gynecology & Infertility', mobile: '+201011112222', isOnline: false, isActive: true,  splits: { consultation: 50, operative: 80, online: 70 }, todayAppointments: 12, monthRevenue: 48_000, rating: 4.9, paymentMethod: 'instapay' },
  { id: 'd2', nameAr: 'د. خالد رشاد',    nameEn: 'Dr. Khaled Rashad',  specialtyAr: 'الأطفال والمواليد', specialtyEn: 'Pediatrics & Newborn',     mobile: '+201022223333', isOnline: false, isActive: true,  splits: { consultation: 50, operative: 80, online: 70 }, todayAppointments: 9,  monthRevenue: 32_000, rating: 4.7, paymentMethod: 'bank_transfer' },
  { id: 'd3', nameAr: 'د. سامر نور',     nameEn: 'Dr. Samer Nour',     specialtyAr: 'القلب',             specialtyEn: 'Cardiology',               mobile: '+201033334444', isOnline: true,  isActive: true,  splits: { consultation: 60, operative: 80, online: 70 }, todayAppointments: 7,  monthRevenue: 55_000, rating: 4.8, paymentMethod: 'cash' },
  { id: 'd4', nameAr: 'د. رانيا سعيد',   nameEn: 'Dr. Rania Said',     specialtyAr: 'الجلدية',           specialtyEn: 'Dermatology',              mobile: '+201044445555', isOnline: false, isActive: true,  splits: { consultation: 50, operative: 75, online: 70 }, todayAppointments: 10, monthRevenue: 38_000, rating: 4.6, paymentMethod: 'instapay' },
  { id: 'd5', nameAr: 'د. محمود طه',     nameEn: 'Dr. Mahmoud Taha',   specialtyAr: 'الباطنة',           specialtyEn: 'Internal Medicine',        mobile: '+201055556666', isOnline: false, isActive: false, splits: { consultation: 50, operative: 80, online: 70 }, todayAppointments: 0,  monthRevenue: 0,      rating: 4.5, paymentMethod: 'cash' },
];
                ...
                <tbody>
                  {filtered.map((d) => (
                    ...
                    >
                      ...
                      {!selected && <>
                        <td className="px-5 py-3.5 text-gray-700 dark:text-gray-200 tabular-nums font-mono">
                          {d.todayAppointments} {t('موعد', 'appts')}
                        </td>
                        <td className="px-5 py-3.5 text-gray-700 dark:text-gray-200 font-mono tabular-nums">
                          {formatCurrency(d.monthRevenue, 'EGP', lang === 'ar' ? 'ar-EG' : 'en-US')}
                        </td>
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-1 text-amber-500">
                            <Star className="w-3.5 h-3.5 fill-current" />
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-200 tabular-nums">{d.rating}</span>
                          </div>
                        </td>
                      </>}
                      <td className="px-5 py-3.5">
